#!/bin/bash
# ⚠️ DEPRECATED (2026-05-12):
# The Automator .wflow generated by this script is broken on macOS Sequoia 15.6+
# (and Tahoe / 2026). Triggering the Quick Action raises:
#   INTERNAL ERROR: -[__NSCFConstantString objCType]: unrecognized selector
#   sent to instance ...
# The "Capture to Wiki" entry appears in the Services menu but clicking it
# does nothing; a bound keyboard shortcut also does nothing.
#
# Use the Shortcuts.app route instead. See setup-new-machine.md §4.
# Quick install via iCloud share link (one click in the browser):
#   https://www.icloud.com/shortcuts/0ac7c59e386148a88a4331df3d0ea889
#
# This script is kept for historical reference; do not run on new machines.
#
